package AccesoProgramas.Ejercicio10.Programas.Imitador;
...
public class Imitador extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanelMenuImitador.setMaximumSize(new java.awt.Dimension(500, 50));
        jPanelMenuImitador.setMinimumSize(new java.awt.Dimension(500, 50));
        jPanelMenuImitador.setPreferredSize(new java.awt.Dimension(500, 50));
        ...
        getContentPane().add(jPanelMenuImitador);

        jPanel8.setMaximumSize(new java.awt.Dimension(500, 350));
        jPanel8.setMinimumSize(new java.awt.Dimension(500, 350));
        ...
        jPanel8.add(jSeparatorOriginalEspejo);
