package AccesoProgramas.Ejercicio10.Programas.MezcladorNombres;
...
public class Mezclador extends javax.swing.JFrame {
    ...
    public Mezclador() {
        ...
        jPanelMenuMezclador.removeAll();
        jPanelMenuMezclador.add(m, BorderLayout.CENTER);
        jPanelMenuMezclador.revalidate();
        jPanelMenuMezclador.repaint();
    }
    ...
    private void initComponents() {
        ...
        jPanelMenuMezclador = new javax.swing.JPanel();
        ...
        jPanelMenuMezclador.setMaximumSize(new java.awt.Dimension(450, 50));
        jPanelMenuMezclador.setMinimumSize(new java.awt.Dimension(450, 50));
        jPanelMenuMezclador.setPreferredSize(new java.awt.Dimension(450, 50));

        javax.swing.GroupLayout jPanelMenuMezcladorLayout = new javax.swing.GroupLayout(jPanelMenuMezclador);
        jPanelMenuMezclador.setLayout(jPanelMenuMezcladorLayout);
        jPanelMenuMezcladorLayout.setHorizontalGroup(
            jPanelMenuMezcladorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 450, Short.MAX_VALUE)
        );
        jPanelMenuMezcladorLayout.setVerticalGroup(
            jPanelMenuMezcladorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 50, Short.MAX_VALUE)
        );

        getContentPane().add(jPanelMenuMezclador);
    ...
    private javax.swing.JPanel jPanelMenuMezclador;
